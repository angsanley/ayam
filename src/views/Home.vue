<template>
    <div class="home pt-8 lg:h-screen">
        <div class="grid grid-cols-12 h-full lg:overflow-y-hidden">
            ...
            <perfect-scrollbar :options="{handlers: ['click-rail', 'drag-thumb', 'keyboard', 'wheel']}" class="lg:overflow-y-scroll h-full xl:col-span-9 lg:col-span-8 col-span-12 w-full px-6 md:px-8 lg:px-10">
            ...
            <perfect-scrollbar :options="{handlers: ['click-rail', 'drag-thumb', 'keyboard', 'wheel']}" class="lg:overflow-y-scroll h-full pb-8 pl-6 lg:pl-2 xl:col-span-3 lg:col-span-4 col-span-12 pr-6 md:pr-8 lg:pr-4 xl:pr-10">
