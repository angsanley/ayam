        ...
        <horizontal-scrolling-container>
            <div class="card assignment-card flex flex-shrink-0" v-for="videoConference in this.videoConferences" :key="videoConference['Title']">
                <div class="flex flex-col h-full justify-between">
                    ...
                    <a class="button default-button mt-2 text-center no-underline text-sm" :href="videoConference['Link']" target="_blank"><i class="fas fa-external-link-alt"/> Open in Zoom</a>
